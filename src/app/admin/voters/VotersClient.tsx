...
export function VotersClient({
  ...
  return (
    <>
      <div className="flex flex-wrap items-center gap-3 bg-[#0d1f3c] p-4 rounded-2xl border border-white/10">
        ...
        <select
          ...
          className="rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-nabams-green"
        >
      ...
      <div className={`rounded-2xl border border-white/10 overflow-x-auto ${isPending ? 'opacity-50 pointer-events-none' : 'opacity-100'} transition-opacity duration-200`}>
              ...
              <tr key={v.matric_number} className="hover:bg-white/5 transition-colors">
                ...
                <td className="px-4 py-3">
                  <Link href={`/admin/voters/${v.matric_number}`}>
                    <Button variant="ghost" size="sm" className="!px-2 !py-1 text-nabams-gold hover:bg-nabams-gold/20">
