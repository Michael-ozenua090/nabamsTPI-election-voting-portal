    ...
    return (
      <main className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="max-w-md text-center bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          <div className="inline-flex h-20 w-20 items-center justify-center rounded-full border border-amber-200 bg-amber-50 mb-6 text-amber-600">
            <span className="text-4xl" role="img" aria-label="Paused">
              {status === 'paused' ? <i className="fa-solid fa-pause"></i> : <i className="fa-solid fa-hourglass-half"></i>}
            </span>
          </div>
